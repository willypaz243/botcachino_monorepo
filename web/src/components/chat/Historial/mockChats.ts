...
export const MOCK_CHATS: ChatSession[] = [
  ...
  {
    id: generateId(),
    title: 'Diseño UX/UI contemporáneo',
    createdAt: new Date(Date.now() - 5.5 * 24 * 60 * 60 * 1000),
    updatedAt: new Date(Date.now() - 5.5 * 24 * 60 * 60 * 1000),
    messages: [
      createMessage(
        'user',
        '¿Cuáles son las tendencias de diseño para 2026?',
        new Date(Date.now() - 5.5 * 24 * 60 * 60 * 1000)
      ),
      createMessage(
        'assistant',
        'Dark mode prevalente, glassmorphism, micro-interacciones, espacios en blanco generoso, tipografía variable, animaciones sutiles. Enfoque en accesibilidad (WCAG 2.1 AA mínimo) y mobile-first sin sacrificar desktop...',
        new Date(Date.now() - 5.49 * 24 * 60 * 60 * 1000)
      ),
    ],
  },

  {
    ...
    messages: [
      createMessage(
        'user',
        '¿Cómo escribo tests efectivos para componentes React?',
        new Date(Date.now() - 6 * 24 * 60 * 60 * 1000)
      ),
      createMessage(
        'assistant',
        'Evita testing de implementación. Test lo que el usuario ve. Usa screen.getByRole, screen.getByLabelText. Mockea solo APIs externas. Aima el 80% de coverage, no el 100%...',
        new Date(Date.now() - 6 * 24 * 60 * 60 * 1000 + 20 * 60 * 1000)
      ),
    ],
  },
  ...
  {
    id: generateId(),
    title: 'Análisis de Criptografía moderna',
    createdAt: new Date(Date.now() - 10 * 24 * 60 * 60 * 1000),
    updatedAt: new Date(Date.now() - 10 * 24 * 60 * 60 * 1000),
    messages: [
      createMessage(
        'user',
        '¿Qué es RSA y Curvas Elípticas?',
        new Date(Date.now() - 10 * 24 * 60 * 60 * 1000)
      ),
      createMessage(
        'assistant',
        'RSA es criptografía de clave pública basada en factorización. Curvas Elípticas (ECDSA) ofrecen la misma seguridad con claves más pequeñas, más eficientes. ECC es el futuro para criptografía asimétrica...',
        new Date(Date.now() - 10 * 24 * 60 * 60 * 1000 + 25 * 60 * 1000)
      ),
    ],
  },

  {
    ...
    messages: [
      ...
      createMessage(
        'assistant',
        'Scrum=ciclos de 2-4 semanas con sprints, ideales para equipos nuevos. Kanban=flujo continuo, mejor para maintenance. Scrumban combina ambos. Elige según contexto del proyecto...',
        new Date(Date.now() - 12 * 24 * 60 * 60 * 1000 + 10 * 60 * 1000)
      ),
    ],
  },
  ...
  {
    id: generateId(),
    title: 'Sostenibilidad en desarrollo',
    createdAt: new Date(Date.now() - 15 * 24 * 60 * 60 * 1000),
    updatedAt: new Date(Date.now() - 15 * 24 * 60 * 60 * 1000),
    messages: [
      createMessage(
        'user',
        '¿Cómo hacer aplicaciones más eficientes energéticamente?',
        new Date(Date.now() - 15 * 24 * 60 * 60 * 1000)
      ),
      createMessage(
        'assistant',
        'Minimiza re-renders innecesarios en React, usa lazy loading, optimiza imágenes, evita bloating de librerías. Tree-shaking en bundlers. Considera Web Vitals. Cada KB importa para UX y medio ambiente...',
        new Date(Date.now() - 15 * 24 * 60 * 60 * 1000 + 35 * 60 * 1000)
      ),
    ],
  },
];
